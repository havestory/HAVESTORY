  ...
  try {
    ...
    await client.query(`
      ...
      CREATE TABLE IF NOT EXISTS orders (
        ...
        payment_amount INTEGER NOT NULL DEFAULT 0, payment_type TEXT NOT NULL DEFAULT 'advance',
        payment_submitted_amount INTEGER NOT NULL DEFAULT 0, payment_proof_status TEXT NOT NULL DEFAULT 'not_uploaded',
