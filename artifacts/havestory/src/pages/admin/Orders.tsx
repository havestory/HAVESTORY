...
export default function Orders() {
  ...
  const copyTrackLink = async () => {
    if (!manageOrder) return;
    const link = `${window.location.origin}/track-order?token=${encodeURIComponent((manageOrder as any).trackingToken || '')}`;
    try {
