...
export default function AdminSettings() {
  ...
  if (settings && !loaded) {
    ...
    setForm({
      ...
      footerCopyrightText: (settings as any).footerCopyrightText || "© 2026 HAVESTORY",
      footerDeveloperCredit: (settings as any).footerDeveloperCredit || "Designed & Built by CODEARTIX",
      footerDeveloperUrl: (settings as any).footerDeveloperUrl || "",
  ...
  const sections = [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "footerCopyrightText", label: "Footer Copyright Text", placeholder: "© 2026 HAVESTORY" },
        { key: "footerDeveloperCredit", label: "Footer Developer Credit", placeholder: "Designed & Built by CODEARTIX" },
        { key: "footerDeveloperUrl", label: "Developer Website URL (optional)", placeholder: "https://codeartix.com" },
