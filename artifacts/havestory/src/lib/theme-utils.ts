...
export const THEME_VARS: Record<string, ThemeVars> = {
  // Modern Atelier — porcelain paper, warm ink, terracotta clay accent.
  "atelier-light": { from: "#faf9f5", to: "#1b1a15", accent: "#a85d3c", primary: "45 10% 9%", secondary: "18 48% 45%" },
  "light-premium": { from: "#faf9f5", to: "#1b1a15", accent: "#a85d3c", primary: "45 10% 9%", secondary: "18 48% 45%" },
  "light-editorial": { from: "#faf9f5", to: "#1b1a15", accent: "#a85d3c", primary: "45 10% 9%", secondary: "18 48% 45%" },
  "havestory-gallery": { from: "#faf9f5", to: "#1b1a15", accent: "#a85d3c", primary: "45 10% 9%", secondary: "18 48% 45%" },
