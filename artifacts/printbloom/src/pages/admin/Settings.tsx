...
function CourierServicesManager({ couriers, onChange }: {
  ...
  const inp = "flex-1 px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-pink-400 transition-colors placeholder:text-gray-400";
  ...
  const rateInp = "w-full pl-9 pr-2.5 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:border-pink-400 text-right font-semibold transition-colors";
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start sm:items-center justify-between gap-3 flex-wrap">
        ...
        <button disabled={isPending} onClick={handleSave} className="flex items-center gap-1.5 px-3 sm:px-4 py-2 rounded-lg bg-gradient-to-r from-pink-500 to-purple-600 text-white text-xs sm:text-sm font-bold shadow-sm disabled:opacity-60 shrink-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-pink-200"
              />
            ...
            <div className="mt-5 pt-4 border-t border-gray-100">
              ...
              <p className="text-[11px] text-gray-400 mb-3">
                One-time setup. Generate an App Password at <a href="https://myaccount.google.com/apppasswords" target="_blank" rel="noreferrer" className="text-pink-500 underline">myaccount.google.com/apppasswords</a> (2-Step Verification must be ON). The password is 16 characters and only shown once on Google's side.
              </p>
                ...
                <div className="space-y-1.5 min-w-0">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3 py-2.5 pr-10 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-pink-200 font-mono tracking-wider"
                    />
                    <button
                      type="button"
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold bg-pink-50 text-pink-600 border border-pink-200 hover:bg-pink-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex gap-3 flex-wrap items-center">
              <button type="button" onClick={() => logoInputRef.current?.click()} disabled={logoUploading}
                className="flex items-center gap-2 px-4 py-2 rounded-xl border-2 border-dashed border-gray-200 hover:border-pink-300 text-sm text-gray-500 hover:text-pink-500 transition-all">
      ...
      <div className="space-y-5">
        {sections.map(section => (
          <div key={section.title} className="bg-white border border-gray-100 rounded-2xl shadow-sm p-4 sm:p-6">
            <div className="flex items-center gap-2 mb-4 sm:mb-5">
              <section.icon size={18} className="text-pink-400" />
              ...
              {section.fields.map(f => {
                ...
                return (
                  <div key={f.key} className={isTextarea ? "sm:col-span-2" : ""}>
                    ...
                    {isTextarea ? (
                      <>
                        <textarea value={form[f.key] || ""} onChange={e => set(f.key, e.target.value)} rows={f.key === "whatsappOrderTemplate" ? 6 : 3} placeholder={f.placeholder} className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-pink-200 resize-none" />
                        {f.key === "whatsappOrderTemplate" && (
                          <p className="text-[10px] text-gray-400 mt-1.5">Available placeholders: <span className="font-mono text-pink-500">{"{customerName}"}</span> · <span className="font-mono text-pink-500">{"{orderNumber}"}</span> · <span className="font-mono text-pink-500">{"{trackingLink}"}</span></p>
                        )}
                      </>
                    ) : (
                      <input value={form[f.key] || ""} onChange={e => set(f.key, e.target.value)} placeholder={f.placeholder} className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-pink-200" />
                    )}
                  </div>
                );
              })}
        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-6">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl mb-5">
            ...
            >
              {form.ipayEnabled
                ? <ToggleRight size={36} className="text-pink-500" />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2.5 pr-10 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-pink-200 font-mono"
                />
          ...
          <div className="mt-5 flex items-center gap-3 pt-4 border-t border-gray-100">
            <button
              ...
              disabled={ipaySaving}
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-pink-50 border border-pink-200 text-pink-700 text-sm font-semibold hover:bg-pink-100 transition-colors disabled:opacity-60"
            >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-pink-200 resize-none"
                />
              </div>
            </div>
      ...
      <div className="flex justify-end">
        <button disabled={isPending} onClick={handleSave} className="flex items-center gap-1.5 px-6 py-2.5 rounded-xl bg-gradient-to-r from-pink-500 to-purple-600 text-white text-sm font-bold shadow-sm disabled:opacity-60">
