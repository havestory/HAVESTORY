...
const inp = "w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-100 transition-colors placeholder:text-gray-400";
    ...
    <div>
      ...
      <div className="flex gap-1 mb-3 bg-gray-100 p-1 rounded-xl w-fit">
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${mode === "upload" ? "bg-white text-pink-600 shadow-sm" : "text-gray-500 hover:text-gray-800"}`}
        >
        ...
        <div className="border-2 border-dashed border-gray-200 rounded-2xl overflow-hidden bg-gray-50/50">
          {value ? (
            ...
            <button
              type="button"
              onClick={() => ref.current?.click()}
              className="w-full py-10 flex flex-col items-center gap-2 hover:bg-pink-50/50 transition-colors"
            >
      ...
      <div className="flex items-center gap-1.5 mt-2">
        <div className="px-2.5 py-1 bg-purple-50 border border-purple-100 rounded-full text-[10px] font-bold text-purple-600">
...
function SectionHeader({ icon: Icon, title, desc }: { icon: React.ElementType; title: string; desc: string }) {
  return (
    <div className="flex items-start gap-3 mb-6">
      <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-pink-100 to-purple-100 flex items-center justify-center shrink-0">
  ...
  return (
    <div className="flex justify-end mt-6 pt-5 border-t border-gray-100">
      <button
        ...
        className={`flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${saved ? "bg-green-500 text-white" : "bg-gradient-to-r from-pink-500 to-purple-600 text-white hover:opacity-90 disabled:opacity-70"}`}
      >
...
const PORTFOLIO_CATEGORIES = ["Printing", "Packaging", "Branding", "Banners", "Invitations", "Stationery", "Signage", "Other"];
...
const emptyPForm = () => ({
  title: "", category: "Printing", clientName: "", description: "",
...
export default function WebsiteEditor() {
  ...
  /* ── THEME STATE ── */
  const [themePreset, setThemePreset] = useState("pink-purple");
  ...
  useEffect(() => {
    ...
    setThemePreset(s.themePreset || "pink-purple");
        ...
        {TABS.map(t => {
          ...
          return (
            <button
              key={t.id}
              onClick={() => setTab(t.id)}
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold whitespace-nowrap transition-all ${active ? "bg-white text-pink-600 shadow-sm" : "text-gray-500 hover:text-gray-800"}`}
            >
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="🌸 Premium Printing in Sri Lanka"
                  className={inp}
                />
                <p className="text-[10px] text-gray-400 mt-1">Short label shown in the pink pill above the main heading</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Premium Printing for Every Vision"
                  className={inp}
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="From business cards to large banners, we bring your vision to life..."
                  className={ta}
                />
              </div>
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  {homeFeatureCards.map((card, index) => (
                    <div key={index} className="rounded-2xl border border-gray-100 bg-gray-50/60 p-3 space-y-2">
                      <div className="text-[10px] font-black uppercase tracking-wide text-pink-500">Card {index + 1}</div>
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-400 mb-3">
                  ...
                  Ideal size: <strong>800 × 1000 px</strong> (portrait, 4:5 ratio). Use print product photos, design samples, or mockups for best results.
                </p>
        ...
        {tab === "portfolio" && (
          <div>
            <div className="flex items-start justify-between mb-6">
              ...
              {!showPForm && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white text-sm font-bold rounded-xl shadow-md shrink-0"
                >
            ...
            {/* Add / Edit Form */}
            {showPForm && (
              <div className="mb-6 border border-pink-100 rounded-2xl bg-pink-50/30 p-5 space-y-5">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-200 rounded-xl overflow-hidden bg-white">
                    {pCoverUrl ? (
                      ...
                      <button onClick={() => pCoverRef.current?.click()} className="w-full py-8 flex flex-col items-center gap-2 hover:bg-pink-50/50">
                ...
                <div>
                  <div className="text-[10px] text-gray-400 font-bold tracking-widest mb-2">
                    GALLERY IMAGES
                    {pGallery.length > 1 && (
                      <span className="ml-2 text-pink-400 normal-case font-normal tracking-normal">drag to reorder</span>
                    )}
                  </div>
                  <Reorder.Group
                    axis="x"
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      disabled={pUploading}
                      className="w-20 h-20 rounded-xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center gap-1 hover:border-pink-400 hover:bg-pink-50/50 transition-all text-gray-400 flex-shrink-0"
                    >
                      {pUploading
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <div
                      ...
                      className={`w-10 h-5.5 rounded-full transition-colors relative cursor-pointer ${pForm.featured ? "bg-gradient-to-r from-pink-500 to-purple-600" : "bg-gray-200"}`}
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={submitPForm} disabled={!pForm.title || creatingP || updatingP} className="px-5 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white text-sm font-bold rounded-xl disabled:opacity-50">
                  ...
                  return (
                    <div key={item.id} className="border border-gray-100 rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <div className="relative h-36 bg-gray-100">
                        ...
                        {item.featured && (
                          <div className="absolute top-2 left-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full flex items-center gap-1">
                        ...
                        <div className="flex items-start justify-between gap-2">
                          <div className="min-w-0">
                            ...
                            <div className="flex items-center gap-1.5 mt-0.5">
                              <span className="text-[10px] font-semibold text-pink-600 bg-pink-50 px-1.5 py-0.5 rounded">{item.category}</span>
                        ...
                        {(item.tags || []).length > 0 && (
                          <div className="flex flex-wrap gap-1 mt-2">
                            {(item.tags || []).slice(0, 3).map((t: string) => (
                              <span key={t} className="text-[10px] text-purple-600 bg-purple-50 px-1.5 py-0.5 rounded-full">{t}</span>
                            ))}
                          </div>
                        )}
                      </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="printing sri lanka, graphic design, business cards, banners"
                  className={inp}
                />
