...
export default function Store() {
  ...
  return (
    <div className="glass-gallery-store gallery-tides-store min-h-screen bg-background flex flex-col">
      ...
      <div className="glass-gallery-store-hero store-hero-compact editorial-hero relative overflow-hidden noise">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-8 px-6 py-14 lg:grid-cols-[1fr_auto] lg:items-end lg:px-10 lg:py-16">
          <div>
            <div className="mb-6"><span className="editorial-kicker">The HAVESTORY Edit</span></div>
            <h1 className="editorial-display max-w-3xl text-4xl leading-[0.94] text-white sm:text-5xl lg:text-7xl">Objects made<br /><span className="text-gradient italic">to hold meaning.</span></h1>
            <p className="mt-5 max-w-xl text-sm leading-relaxed text-primary-foreground/70 sm:text-base">Choose a frame, build a collection, and let our studio turn your favourite moments into something you will want to keep close.</p>
      ...
      <section className="glass-gallery-store-route-section border-b border-border bg-background px-6 py-12 lg:px-10 lg:py-16">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            {[
              ...
              <Link key={route.label} href={route.href} className="glass-frame glass-interactive glass-gallery-store-route-card group relative min-h-[15rem] overflow-hidden border border-border bg-card sm:min-h-[16rem]">
                ...
                <div className="relative flex min-h-[15rem] flex-col justify-end p-5 sm:min-h-[16rem] sm:p-6">
      ...
      <div id="collection" className="glass-gallery-store-collection mx-auto flex w-full max-w-7xl flex-1 flex-col gap-8 px-6 py-12 lg:flex-row lg:px-10 lg:py-14">
        ...
        <main className="flex-1">
          ...
          {isLoading ? (
            ...
            <div className="glass-gallery-store-grid grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
