...
export const settingsTable = pgTable("settings", {
  ...
  specialEventType: text("special_event_type").notNull().default("none"),
  specialEventMessage: text("special_event_message").notNull().default(""),
  ...
  heroSlideImage6: text("hero_slide_image6"),
  heroSlideImage7: text("hero_slide_image7"),
