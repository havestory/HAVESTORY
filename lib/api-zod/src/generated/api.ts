...
export const GetSettingsResponse = zod.object({
  ...
  ordersCompletedCount: zod.number(),
  happyClientsPercent: zod.number(),
  ...
  paymentDueDays: zod.number().optional(),
  ...
  googlePayEnabled: zod.number().optional(),
...
export const UpdateSettingsBody = zod.object({
  ...
  aboutImage: zod.string().nullish(),
  ordersCompletedCount: zod.number().optional(),
  happyClientsPercent: zod.number().optional(),
