...
export const getListClientInvoicesQueryOptions = <
  TData = Awaited<ReturnType<typeof listClientInvoices>>,
  TError = ErrorType<unknown>,
>(
  id: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof listClientInvoices>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listClientInvoices>>
  > = ({ signal }) => listClientInvoices(id, { signal, ...requestOptions });
...
export type ListClientInvoicesQueryResult = NonNullable<
  Awaited<ReturnType<typeof listClientInvoices>>
>;
...
export function useListClientInvoices<
  TData = Awaited<ReturnType<typeof listClientInvoices>>,
  TError = ErrorType<unknown>,
>(
  id: number,
...
export const getUpdateNoticeByIdMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type UpdateNoticeByIdMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateNoticeById>>
>;
 ...
 * @summary Update a notice by id
 */
export const useUpdateNoticeById = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getDeleteNoticeByIdMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type DeleteNoticeByIdMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteNoticeById>>
>;
 ...
 * @summary Delete a notice by id
 */
export const useDeleteNoticeById = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getNotice = async (options?: RequestInit): Promise<SiteNotice> => {
...
export const getGetNoticeQueryOptions = <
  ...
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<Awaited<ReturnType<typeof getNotice>>, TError, TData>;
  request?: SecondParameter<typeof customFetch>;
}) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getNotice>>> = ({
    signal,
  }) => getNotice({ signal, ...requestOptions });
